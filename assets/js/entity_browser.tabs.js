...
(function ($, Drupal, drupalSettings, once) {
  ...
  Drupal.theme.entityTabs = function () {
    return $('<ul role="navigation" class="nav nav-tabs mb-3" aria-label="Tabs"></ul>');
  };
  ...
  Drupal.theme.entityTab = function (settings) {
    return $('<li tabindex="-1"></li>')
      ...
      .append($('<a href="#"></a>').addClass("nav-link").addClass(settings.class).attr('data-button-id', settings.id)
